...
export class AuditLog {
  ...
  // Valid values: login_success | login_failed | logout | profile_edit | password_requested | password_changed | avatar_changed | role_changed | status_changed | password_reset_by_admin
  action: string;
